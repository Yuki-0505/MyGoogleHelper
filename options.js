...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
  ...
  function (t) {
    ...
    console.log(t), $("#auto-open-homepage").click(function () {
      $(this).is(":checked") ? (localStorage["auto-homepage"] = "true", $("#choose-homepage").show(), localStorage.homepage || (localStorage.homepage = "http://123.hao245.com")) : (localStorage["auto-homepage"] = "false", $("#choose-homepage").hide())
      // 移除homepage属性
